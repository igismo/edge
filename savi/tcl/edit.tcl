...
########  GORAN
    build_LabelEntryColumns $cmd letype \
        {lentry "Satellite type" edit_oe(type)}

    bind $cmd.letype.c0.0 <Return> edit(oe)
    bind $cmd.letype.c0.0 <Tab> edit(oe)
#########
...
### GORAN 1 line
    satellites TYPE $m "$edit_oe(type)"
...
### GORAN
       set edit_oe(type) [eval satellites GET_TYPE $n]
    }
